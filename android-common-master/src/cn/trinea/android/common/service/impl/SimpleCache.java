...
public class SimpleCache<K, V> implements Cache<K, V>, Serializable {
     ...
     * @see cn.trinea.android.common.service.impl.SimpleCache#put(Object, CacheObject)
     */
    @Override
     ...
     * @param key
     * @return
     * @see cn.trinea.android.common.service.impl.SimpleCache#isExpired(CacheObject)
     */
