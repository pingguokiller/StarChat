 ...
 * <li>{@link cn.trinea.android.common.util.ViewUtils#getListViewHeightBasedOnChildren(ListView)}</li>
 * <li>{@link cn.trinea.android.common.util.ViewUtils#getAbsListViewHeightBasedOnChildren(AbsListView)}</li>
 * </ul>
 * <ul>
 * <strong>set view height</strong>
 * <li>{@link cn.trinea.android.common.util.ViewUtils#setViewHeight(View, int)} set view height</li>
 * <li>{@link cn.trinea.android.common.util.ViewUtils#setListViewHeightBasedOnChildren(ListView)}</li>
 * <li>{@link cn.trinea.android.common.util.ViewUtils#setAbsListViewHeightBasedOnChildren(AbsListView)}</li>
 * </ul>
 * <ul>
 * <strong>get other info</strong>
 * <li>{@link cn.trinea.android.common.util.ViewUtils#getGridViewVerticalSpacing(GridView)} get GridView vertical spacing</li>
 * </ul>
 * <ul>
 * <strong>set other info</strong>
 * <li>{@link cn.trinea.android.common.util.ViewUtils#setSearchViewOnClickListener(View, OnClickListener)}</li>
 * </ul>
 * 
