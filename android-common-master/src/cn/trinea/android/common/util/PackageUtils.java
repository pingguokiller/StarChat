 ...
 * <li>{@link cn.trinea.android.common.util.PackageUtils#installNormal(Context, String)}</li>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#installSilent(Context, String)}</li>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#install(Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Uninstall package</strong>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#uninstallNormal(Context, String)}</li>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#uninstallSilent(Context, String)}</li>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#uninstall(Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Is system application</strong>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#isSystemApplication(Context)}</li>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#isSystemApplication(Context, String)}</li>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#isSystemApplication(PackageManager, String)}</li>
 * </ul>
 * <ul>
 * <strong>Others</strong>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#getInstallLocation()} get system install location</li>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#isTopActivity(Context, String)} whether the app whost package's name is packageName is on the
 * top of the stack</li>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#startInstalledAppDetails(Context, String)} start InstalledAppDetails Activity</li>
 * </ul>
 * 
...
public class PackageUtils {
     ...
     *         {@link cn.trinea.android.common.util.PackageUtils}.INSTALL_FAILED_*. same to {@link PackageManager}.INSTALL_*
