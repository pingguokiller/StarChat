...
public class JSONUtils {
     ...
     *         <li>return {@link cn.trinea.android.common.util.JSONUtils#getLong(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see cn.trinea.android.common.util.JSONUtils#getLong(JSONObject, String, Long)
     */
    public static long getLong(JSONObject jsonObject, String key, long defaultValue) {
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link cn.trinea.android.common.util.JSONUtils#getInt(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see cn.trinea.android.common.util.JSONUtils#getInt(JSONObject, String, Integer)
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link cn.trinea.android.common.util.JSONUtils#getDouble(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see cn.trinea.android.common.util.JSONUtils#getDouble(JSONObject, String, Double)
     */
    public static double getDouble(JSONObject jsonObject, String key, double defaultValue) {
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link cn.trinea.android.common.util.JSONUtils#getString(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link cn.trinea.android.common.util.JSONUtils#getStringArray(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link cn.trinea.android.common.util.JSONUtils#getStringList(JSONObject, String, java.util.List)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonData is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link cn.trinea.android.common.util.JSONUtils#getJSONObject(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link cn.trinea.android.common.util.JSONUtils#getJSONArray(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link cn.trinea.android.common.util.JSONUtils#getBoolean(JSONObject, String, Boolean)}</li>
     *         </ul>
     */
     ...
     *         <li>return {@link cn.trinea.android.common.util.JSONUtils#getMap(JSONObject, String)}</li>
     *         </ul>
     */
     ...
     *         <li>return {@link cn.trinea.android.common.util.JSONUtils#parseKeyAndValueToMap(JSONObject)}</li>
     *         </ul>
     */
